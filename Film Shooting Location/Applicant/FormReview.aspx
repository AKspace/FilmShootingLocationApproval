<%@ Page Title="" Language="C#" MasterPageFile="~/Applicant/ApplicantMaster.master" AutoEventWireup="true" CodeFile="FormReview.aspx.cs" Inherits="Applicant_review1" %>
    ...
    <div class="divStyle">
            ...
            <!--Row1-->
                    ...
                    <asp:UpdatePanel runat="server" ID="up1">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlApplicationid" AutoPostBack="true" Visible="True" runat="server" OnSelectedIndexChanged="ddlApplicationid_SelectedIndexChanged" ></asp:DropDownList>
        ...
        <asp:Button ID="btnSubmit" runat="server" Text="Pay Now" CssClass="btn btn-primary" OnClick="btnSubmit_Click" style="margin-left:1%;display:inline;"/>
        </span>
        <br />
        <br />
    </div>
