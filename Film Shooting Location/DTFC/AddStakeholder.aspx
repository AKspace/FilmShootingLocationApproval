<%@ Page Title="Add Stakeholder" Language="C#" MasterPageFile="~/DTFC/DTFCMaster.master" AutoEventWireup="true" CodeFile="AddStakeholder.aspx.cs" Inherits="Administrator_AddStakeholder" %>
    ...
    <%--					<form role="form">--%>
						<fieldset>
                            ...
                            <div class="form-group col-md-12 col-lg-12 col-sm-12">
                                ...
                                <textarea id="txtDescription" cols="50" rows="4" placeholder="Description" name="txtDescription"  runat="server" class="form-control" style="resize:none" ClientIDMode="static"></textarea>
                            </div>
                            ...
                            <div class="form-group col-md-12 col-lg-12 col-sm-12">
                                ...
                                <textarea id="txtAddress" cols="50" rows="4" placeholder="Address" name="txtAddress"  runat="server" class="form-control" style="resize:none" ClientIDMode="static"></textarea>
                            </div>
