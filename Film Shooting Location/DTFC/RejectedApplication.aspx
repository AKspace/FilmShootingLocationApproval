<%@ Page Title="" Language="C#" MasterPageFile="~/DTFC/DTFCMaster.master" AutoEventWireup="true" CodeFile="RejectedApplication.aspx.cs" Inherits="DTFC_RejectedApplication" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        function Select(chkId) {           
            var gridId = document.getElementById("<%= RejectedApplication.ClientID %>");          
            var cell;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <asp:GridView id="RejectedApplication" runat="server" Width="100%" DataKeyNames="applicationid" EmptyDataText="NO RECORDS!" GridLines="None" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" CellPadding="4" ForeColor="#333333"  RowStyle-Height="50px">
