<%@ Page Title="" Language="C#" MasterPageFile="~/DTFC/DTFCMaster.master" AutoEventWireup="true" CodeFile="StakeholderDetails.aspx.cs" Inherits="Administrator_StakeholderDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <div>
        <asp:GridView ID="stackholderDetails" runat="server" Width="100%" DataKeyNames="stakeholderid" EmptyDataText="NO RECORDS!" CssClass="" GridLines="None" ShowHeader="true" ShowFooter="false" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="50px" OnRowDataBound="manageStack_RowDataBound"  RowStyle-Height="50px" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center" >
            <Columns>
        ...
        <table width="95% cellpadding="0px" cellspacing="0px" >
            <tr >
                <td style="width: 47%; text-align: left; vertical-align: middle;">
                    ...
                    <asp:Button ID="btnAdd" runat="server" CssClass="btnClass" Text="Add New Stakeholder" PostBackUrl="/DTFC/AddStakeholder.aspx"></asp:Button>
                </td>
