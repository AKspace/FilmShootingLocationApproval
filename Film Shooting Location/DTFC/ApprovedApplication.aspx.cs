...
public partial class DTFC_ApprovedApplication : System.Web.UI.Page
{
    ...
    protected void linkButtonView_Click(object sender, EventArgs e)
    {
        ...
        string appid = ApprovedApplication.DataKeys[gvRow.RowIndex].Value.ToString();
        Response.Redirect($"FormReview.aspx?AppID={appid}");
    }
    private void FillGridView()
    {
        ApprovedApplication.DataSource = dtfcController.GetApprovedApplication();
        ApprovedApplication.DataBind();
    }
}