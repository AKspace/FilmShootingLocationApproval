<%@ Page Title="" Language="C#" MasterPageFile="~/DTFC/DTFCMaster.master" AutoEventWireup="true" CodeFile="LocationDetails.aspx.cs" Inherits="Administrator_ManageStackHolder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <asp:GridView id="LocationDetails" runat="server" Width="100%" DataKeyNames="locationid" EmptyDataText="NO RECORDS!" GridLines="None" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" OnRowDataBound="LocationDetails_RowDataBound" CellPadding="4" ForeColor="#333333" RowStyle-Height="50px" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
           <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>

             <asp:TemplateField ItemStyle-HorizontalAlign ="left">
                                    <ItemStyle CssClass ="" Width ="5%"/>
                                    <ItemTemplate>
        ...
        <table width="95% cellpadding="0px" cellspacing="0px" >
            <tr >
                <td style="width: 47%; text-align: left; vertical-align: middle;">
                    ...
                    <asp:Button ID="btnAdd" runat="server" CssClass="btnClass" Text="Add New Location" PostBackUrl="/DTFC/AddLocation.aspx"></asp:Button>
                </td>
