...
public partial class DTFC_RejectedApplication : System.Web.UI.Page
{
    ...
    protected void linkButtonView_Click(object sender, EventArgs e)
    {
        ...
        string appid = RejectedApplication.DataKeys[gvRow.RowIndex].Value.ToString();
        Response.Redirect($"FormReview.aspx?AppID={appid}");
    }
    private void FillGridView()
    {
        RejectedApplication.DataSource = dtfcController.GetRejectedApplication();
        RejectedApplication.DataBind();
    }
}