<%@ Page Title="Pending Application" Language="C#" MasterPageFile="~/DTFC/DTFCMaster.master" AutoEventWireup="true" CodeFile="PendingApplication.aspx.cs" Inherits="StakeHolder_PendingApplication" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <script type="text/javascript">
        function Select(chkId) {           
            var gridId = document.getElementById("<%= PendingApplication.ClientID %>");          
            var cell;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
			<ol class="breadcrumb">
                ...
                <li class="active">Pending Applications</li>
			</ol>
		    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <asp:GridView id="PendingApplication" runat="server" Width="100%" DataKeyNames="applicationid" EmptyDataText="NO RECORDS!" GridLines="None" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" CellPadding="4" ForeColor="#333333" OnRowDataBound="PendingApplication_RowDataBound" RowStyle-Height="50px">
           <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
             <asp:TemplateField ItemStyle-HorizontalAlign ="left">
                                ...
                                <asp:BoundField DataField="applicationid" HeaderText="Application Id" ReadOnly="true" ItemStyle-CssClass="" />
                                <asp:BoundField DataField="moviename" HeaderText="Movie Name " ReadOnly="true" ItemStyle-CssClass="" />
<%--                <asp:BoundField DataField=" " HeaderText="Status" ReadOnly="true" ItemStyle-CssClass=""  />--%>
                <asp:BoundField DataField="dateofapplication" HeaderText="Date of Application" ReadOnly="true" ItemStyle-CssClass=""  />
                           <asp:TemplateField HeaderText="&nbsp;&nbsp;Options" ShowHeader="True">
                                    ...
                                    <ItemTemplate>
                                     <%--   <asp:ImageButton ID="ibtnEdit" runat ="server" OnClick="ibtnEdit_Click" CausesValidation="false" ImageUrl="Resources/images/edit.png" ToolTip="Edit"/>&nbsp;
                                        ...
                                        <asp:LinkButton ID="linkForward" runat="server" Text="Forward" OnClick="linkForward_Click"></asp:LinkButton>
                                        <asp:LinkButton ID="LinkReject" runat="server" Text="Reject" OnClick="LinkReject_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
