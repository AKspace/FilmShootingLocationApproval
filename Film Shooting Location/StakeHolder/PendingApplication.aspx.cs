...
public partial class StakeHolder_PendingApplication : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            stakeHolderController.GetPendingApplications(ref gdPendingApplication, sid);
        }
    }
    ...
    protected void linkForward_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/StakeHolder/Approve.aspx?appl='"+gdPendingApplication.DataKeys[gvRow.RowIndex].Value.ToString()+"'");
    }
     protected void LinkReject_Click(object sender, EventArgs e)
    {
        LinkButton linkforward = sender as LinkButton;
        GridViewRow gvRow = (GridViewRow)linkforward.NamingContainer;
        Response.Redirect("~/StakeHolder/Reject.aspx?appl='" + gdPendingApplication.DataKeys[gvRow.RowIndex].Value.ToString() + "'");
    }
