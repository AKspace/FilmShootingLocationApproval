<%@ Page Title="" Language="C#" MasterPageFile="~/StakeHolder/StakeHolderMaster.master" AutoEventWireup="true" CodeFile="PendingApplication.aspx.cs" Inherits="StakeHolder_PendingApplication" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        function Select(chkId) {           
            var gridId = document.getElementById("<%= gdPendingApplication.ClientID %>");          
            var cell;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <asp:GridView id="gdPendingApplication" runat="server" Width="100%" DataKeyNames="applicationid" EmptyDataText="NO RECORDS!" GridLines="None" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" CellPadding="4" ForeColor="#333333" RowStyle-Height="50px">
